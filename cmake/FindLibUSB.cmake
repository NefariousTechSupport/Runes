...
# Originally from https://github.com/stlink-org/stlink/blob/master/cmake/modules/Findlibusb.cmake
...
elseif (WIN32 OR (EXISTS "/etc/debian_version" AND MINGW)) # Windows or MinGW-toolchain on Debian
    ...
    if (WIN32 AND NOT EXISTS "/etc/debian_version") # Skip this for Debian...
        ...
        elseif (MSVC)
            ...
            if (MSVC_TOOLSET_VERSION LESS_EQUAL 120)
                set (LIBUSB_VSVERSION "VS2013")
            elseif (MSVC_TOOLSET_VERSION EQUAL 140)
                set (LIBUSB_VSVERSION "VS2015")
            elseif (MSVC_TOOLSET_VERSION EQUAL 141)
                set (LIBUSB_VSVERSION "VS2017")
            elseif (MSVC_TOOLSET_VERSION GREATER_EQUAL 142)
                set (LIBUSB_VSVERSION "VS2019")
            endif()

            set (LIBUSB_BUILD_TYPE "Release")
            if ((${CMAKE_BUILD_TYPE} STREQUAL "Debug") OR (${CMAKE_BUILD_TYPE} STREQUAL "RelWithDebInfo"))
                set (LIBUSB_BUILD_TYPE "Debug")
            endif()

            find_library(
                LIBUSB_LIBRARY NAMES ${LIBUSB_NAME}
                HINTS ${LIBUSB_WIN_OUTPUT_FOLDER}/${LIBUSB_VSVERSION}/MS${ARCH}/${LIBUSB_BUILD_TYPE}/lib
                NO_DEFAULT_PATH
                NO_CMAKE_FIND_ROOT_PATH
                )
        endif()
